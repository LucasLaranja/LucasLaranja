...
🚀 Foco em **Cloud (AWS)**, **Docker**, **Kubernetes**, **CI/CD**, **GitOps** e **segurança automatizada**
...
- [🧪 CI/CD com FastAPI + GitHub Actions + ArgoCD](https://github.com/LucasLaranja/app-projeto)  
- [📦 Repositório GitOps com manifests Kubernetes](https://github.com/LucasLaranja/hello-manifests)
...
💡 Estudante de engenharia da computação, focado em construir soluções seguras e escaláveis com tecnologia de ponta. Buscando sempre aprender e contribuir!
